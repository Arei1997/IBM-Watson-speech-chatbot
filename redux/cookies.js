...
const encodeJwt = (str) => {
  return jwt.sign(JSON.stringify(str) || {}, config.persistJWT);
};

const decodeJwt = (str) => {
  try {
    const decoded = jwt.verify(str, config.persistJWT);
...
var factory = function (window) {
  ...
  Cookies.get = function (key) {
    ...
    return value === undefined ? undefined : decodeJwt(value);
  };
